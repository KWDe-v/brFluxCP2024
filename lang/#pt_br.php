...
return [
	...
	//'NotAcceptingDonations'   => "Lamentamos, mas nosso sistema de doações está em manutenção. Tente novamente mais tarde.",
	...
	'PasswordChangeNote2'     => 'Após alterar sua senha, você será desconectado.',
	...
	'AccountViewTitle2'       => 'Visualizando Conta (%s)',
	'AccountViewTitle3'       => 'Visualizando Minha Conta',
	...
	'AccountViewHeading'      => 'Visualizando Conta',
	...
	'MainPageInfo'            => "Se você está Visualizando esta página, é porque você instalou o Flux Control Panel com sucesso!",
	...
	'HARTitle'				  => 'Registros de Harmonia',
	...
	'XCMSPageText'			=> 'Este complemento FluxCP permite que administradores e funcionários de servidores criem páginas em seus sites sem nenhum conhecimento prévio de fluxo/codificação. O sistema de notícias integrado também pode ser trocado por um feed RSS, modificando as configurações do complemento.',
	'XCMSNewsTitleError'	=> 'Título da notícia é obrigatório!',
	'XCMSNewsBodyError'		=> 'Corpo da notícia é obrigatório!',
	'XCMSPageTitleError'	=> 'Título da página é obrigatório!',
	'XCMSPageBodyError'		=> 'Corpo da página é obrigatório!',
	'XCMSPagePathError'		=> 'Caminho da página é obrigatório!',
	'XCMSNewsAdded'			=> 'Notícia adicionada ao sistema',
	'XCMSPagesAdded'		=> 'Sua nova página foi adicionada',
	'XCMSNewsUpdated'		=> 'Notícia atualizada',
	'XCMSPageUpdated'		=> 'Sua página foi atualizada',
	'XCMSNewsAddTitle'		=> 'Adicionar um item de notícia',
	'XCMSPageAddTitle'		=> 'Adicionar uma nova página',
	'XCMSNewsEditTitle'		=> 'Editar notícia',
	'XCMSPageEditTitle'		=> 'Editar página',
	'XCMSNewsNotFound'		=> 'Notícia não encontrada!',
	'XCMSPageNotFound'		=> 'Página não encontrada!',
	'XCMSNewsDeleted'		=> 'Notícia excluída',
	'XCMSPageDeleted'		=> 'Sua página foi excluída',
	'XCMSNewsEmpty'			=> 'Nenhum artigo de notícia foi encontrado. Você está usando o Tipo de Notícia correto? (Configuração XCMSNewsType)',
	'XCMSNewsRSSNotFound'	=> 'Feed RSS não pode ser encontrado. Verifique se a configuração XCMSNewsRSS está correta ou altere XCMSNewsType para 1 para usar o sistema de notícias incorporado!',
	'XCMSNewsTXTNotFound'	=> 'A importação de arquivo não funciona nesta versão. O arquivo addon.php realmente informa isso! Alterne XCMSNewsType para 1 para usar o sistema de notícias incorporado, ou 2 para usar o recurso de importação RSS!',
	'XCMSNewsFBNotFound'	=> 'Feed do Facebook não encontrado!',
	'XCMSPageEmpty'			=> 'Nenhuma página adicionada',
	'XCMSNewsLink'			=> 'leia mais...',
	'XCMSEdit'				=> 'Editar',
	'XCMSDelete'			=> 'Excluir',
	'XCMSNewsTitleLabel'	=> 'Título da Notícia',
	'XCMSNewsBodyLabel'		=> 'Corpo da Notícia',
	'XCMSNewsLinkLabel'		=> 'Link da Notícia',
	'XCMSNewsAuthorLabel'	=> 'Autor da Notícia',
	...
	'SDH3StaffList'			=> 'Configurações atuais da equipe',
	'SDH3StaffCreate'		=> 'Adicionar configurações de equipe',
	...
	'CPLogsLabel'     => 'Registros de CP',
	'FluxAdminLabel'     => 'Administração do Flux',
	'PagesLabel'     => 'Páginas',
	'IPBanListLabel'     => 'Lista de Banimentos de IP',
	'GuildsLabel'     => 'Guildas',
	'rALogsLabel'     => 'Registros de rA',
	'SendMailLabel'     => 'Enviar E-mail',
	'ReInstallLabel'     => 'Reinstalar',
	'TaskListLabel'     => 'Lista de Tarefas',
	...
	'ItemDatabaseLabel'     => 'Banco de Dados de Itens',
	'MobDatabaseLabel'     => 'Banco de Dados de Monstros',
	'RateUsOnRMSLabel'     => 'Avalie-nos na RMS!',
	'AccountEmailLabel2'     => 'Confirmar Endereço de E-mail',
	'InvalidEmailconf'     => 'Os endereços de e-mail não correspondem.',
	'InvalidVIPTime'     => 'Tempo VIP inválido.',
	'VIPTimeDateLabel'     => 'VIP Até',
	'VIPStateLabel'     => 'Status VIP',
	'CashLogTitle'     => 'Listar Log de CashPoints',
	'CashLogHeading'     => 'Log de CashPoint',
	'CashLogNotFound'     => 'Nenhum registro de cash encontrado.',
	'CashLogDateLabel'     => 'Data/Hora',
	'CashLogCharacterLabel'     => 'Personagem',
	'CashLogTypeLabel'     => 'Tipo',
	'CashLogCashTypeLabel'     => 'Tipo de Cash',
	'CashLogAmountLabel'     => 'Quantidade',
	'CashLogMapLabel'     => 'Mapa',
	'BranchLogTitle'     => 'Listar Log de Filiais',
	'BranchLogHeading'     => 'Log de Filial',
	'BranchLogNotFound'     => 'Nenhum registro de filial encontrado.',
	'BranchLogIDLabel'     => 'ID do Log de Filial',
	'BranchLogDateLabel'     => 'Data / Hora',
	'BranchLogAccountIDLabel'     => 'ID da Conta',
	'BranchLogCharIDLabel'     => 'ID do Personagem',
	'BranchLogCharNameLabel'     => 'Nome do Personagem',
	'BranchLogMapLabel'     => 'Mapa',
	'CharLogTitle'     => 'Listar Log de Personagem',
	'CharLogHeading'     => 'Log de Personagem',
	'CharLogNotFound'     => 'Nenhum registro de personagem encontrado.',
	'CharLogDateLabel'     => 'Data / Hora',
	'CharLogMsgLabel'     => 'Ação',
	'CharLogAccountIDLabel'     => 'ID da Conta',
	'CharLogCharNumLabel'     => 'Slot do Personagem',
	'CharLogCharNameLabel'     => 'Nome do Personagem',
	'InterLogTitle'     => 'Lista de Log de Interações',
	'InterLogHeading'     => 'Log de Interações',
	'InterLogNotFound'     => 'Nenhum registro de interações encontrado.',
	'InterLogDateLabel'     => 'Data / Hora',
	'InterLogLabel'     => 'Log de Interações',
	'MVPLogTitle'     => 'Listar Log de MVP',
	'MVPLogHeading'     => 'Log de MVP',
	'MVPLogNotFound'     => 'Nenhum registro de MVP encontrado.',
	'MVPLogIDLabel'     => 'ID do Log de MVP',
	'MVPLogDateLabel'     => 'Data / Hora',
	'MVPLogCharacterLabel'     => 'ID do Personagem',
	'MVPLogMonsterLabel'     => 'Monstro MVP',
	'MVPLogPrizeLabel'     => 'Prêmio MVP',
	'MVPLogExpLabel'     => 'Experiência MVP',
	'MVPLogMapLabel'     => 'Mapa',
	'NPCLogTitle'     => 'Listar Log de NPC',
	'NPCLogHeading'     => 'Log de NPC',
	'NPCLogNotFound'     => 'Nenhum registro de NPC encontrado.',
	'NPCLogIDLabel'     => 'ID do NPC',
	'NPCLogDateLabel'     => 'Data / Hora',
	'NPCLogAccountIDLabel'     => 'ID da Conta',
	'NPCLogCharIDLabel'     => 'ID do Personagem',
	'NPCLogCharNameLabel'     => 'Nome do Personagem',
	'NPCLogMapLabel'     => 'Mapa',
	'NPCLogMsgLabel'     => 'Mensagem',
	'MailerSelectTemplateLabel'     => 'Selecionar Modelo',
	'MainPageWelcome'     => 'Bem-vindo ao %s!',
	'CMSNewsHeader'     => 'Anúncios',
	'CMSPageHeader'     => 'Sistema de Gerenciamento de Conteúdo',
	'CMSPageText'     => 'Este módulo permite que administradores e equipe do servidor criem páginas dentro de seu site sem conhecimento prévio de fluxo/codificação. O sistema de notícias integrado também pode ser substituído por um feed RSS modificando as configurações do aplicativo.',
	'CMSNewsTitleError'     => 'Título da notícia é obrigatório!',
	'CMSNewsBodyError'     => 'Corpo da notícia é obrigatório!',
	'CMSPageTitleError'     => 'Título da página é obrigatório!',
	'CMSPageBodyError'     => 'Corpo da página é obrigatório!',
	'CMSPagePathError'     => 'Caminho da página é obrigatório!',
	'CMSNewsAdded'     => 'Notícia adicionada ao sistema',
	'CMSPagesAdded'     => 'Sua nova página foi adicionada',
	'CMSNewsUpdated'     => 'Notícia atualizada',
	'CMSPageUpdated'     => 'Sua página foi atualizada',
	'CMSNewsAddTitle'     => 'Adicionar um item de notícia',
	'CMSPageAddTitle'     => 'Adicionar uma nova página',
	'CMSNewsEditTitle'     => 'Editar notícia',
	'CMSPageEditTitle'     => 'Editar página',
	'CMSNewsNotFound'     => 'Notícia não encontrada!',
	'CMSPageNotFound'     => 'Página não encontrada!',
	'CMSNewsDeleted'     => 'Notícia excluída',
	'CMSPageDeleted'     => 'Sua página foi excluída',
	'CMSNewsEmpty'     => 'Nenhum artigo de notícia foi encontrado. Você está usando o Tipo de Notícia correto? (Configuração CMSNewsType)',
	...
	'CMSPageEmpty'     => 'Nenhuma página adicionada',
	'CMSNewsLink'     => 'leia mais...',
	'CMSEdit'     => 'Editar',
	'CMSDelete'     => 'Excluir',
	'CMSNewsTitleLabel'     => 'Título da Notícia',
	'CMSNewsBodyLabel'     => 'Corpo da Notícia',
	'CMSNewsLinkLabel'     => 'Link da Notícia',
	'CMSNewsAuthorLabel'     => 'Autor da Notícia',
	'CMSPageTitleLabel'     => 'Título da Página',
	'CMSPageBodyLabel'     => 'Corpo da Página',
	'CMSPagePathLabel'     => 'Caminho da Página',
	'CMSCreatedLabel'     => 'Data de Criação',
	'CMSModifiedLabel'     => 'Data de Modificação',
	'CMSActionLabel'     => 'Ação',
	'CMSConfirmDeleteLabel'     => 'Tem certeza de que deseja excluir?',
	'CMSPageCreate'     => 'Criar agora?',
	'CMSOptionalLabel'     => '(Opcional)',
	'CMSRequiredLabel'     => '(Obrigatório)',
	'CMSCreateLabel'     => 'Adicionar Notícia',
	'SDRespTable7'     => 'Resolver Ticket e Creditar Conta',
	'MinCharacters'     => 'Sua senha deve ter entre %d e %d caracteres.',
	'FeedingLogNotFound'     => 'Nenhum registro de Alimentação encontrado..',
	'ResetLook'     => 'Resetar Visual',
	'ResetMap'     => 'Resetar Posição',
	'Reset Look'     => 'Resetar',
	'Reset Position'     => 'Resetar'
