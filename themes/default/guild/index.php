...
<h2>Guildas</h2>
<p class="toggler"><a href="javascript:toggleSearchForm()">Pesquisar...</a></p>
<form action="<?php echo $this->url ?>" method="get" class="search-form">
	<?php echo $this->moduleActionFormInputs($params->get('module')) ?>
	<p>
		<label for="id">ID da Guilda:</label>
	...
	<p>
		<label for="guild_level">Nível da Guilda:</label>
	...
	<p>
		<label for="average_lv">Nível Médio:</label>
...
<table class="horizontal-table">
	<tr>
	    <th><?php echo $paginator->sortableColumn('guild.guild_id', 'ID da Guilda') ?></th>
	    <th colspan="2"><?php echo $paginator->sortableColumn('guildName', 'Nome da Guilda') ?></th>
	    <th><?php echo $paginator->sortableColumn('charID', 'ID do Líder') ?></th>
	    <th><?php echo $paginator->sortableColumn('charName', 'Nome do Líder') ?></th>
	    <th><?php echo $paginator->sortableColumn('guildLevel', 'Nível da Guilda') ?></th>
	    ...
	    <th><?php echo $paginator->sortableColumn('avgLevel', 'Nível Médio') ?></th>
	</tr>
...
<?php else: ?>
<p>Nenhuma guilda encontrada. <a href="javascript:history.go(-1)">Voltar</a>.</p>
<?php endif ?>
