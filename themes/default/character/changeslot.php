...
<h2>Alterar slot de personagem</h2>
...
<form action="<?php echo $this->urlWithQs ?>" method="post" class="generic-form">
	...
	<table class="generic-form-table">
		...
		<tr>
			<th><label for="slot">Número do Slot</label></th>
			...
			<td><p>Você pode inserir um número de slot entre 1 e <?php echo (int)$server->maxCharSlots ?>.</p></td>
		</tr>
		<tr>
