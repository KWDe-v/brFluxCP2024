...
<form action="<?php echo $this->url ?>" method="get" class="search-form">
	...
	<p>
		<label for="use_request_after">Data da solicitação entre:</label>
	...
	<p>
		<label for="use_change_after">Data da alteração entre:</label>
...
<table class="horizontal-table">
	<tr>
		...
		<th><?php echo $paginator->sortableColumn('old_email', 'E-mail Antigo') ?></th>
		<th><?php echo $paginator->sortableColumn('new_email', 'E-mail Novo') ?></th>
		<th><?php echo $paginator->sortableColumn('request_date', 'Request Date') ?></th>
		<th><?php echo $paginator->sortableColumn('request_ip', 'IP de Solicitação') ?></th>
		<th><?php echo $paginator->sortableColumn('change_date', 'Change Date') ?></th>
		<th><?php echo $paginator->sortableColumn('change_ip', 'IP de Alteração') ?></th>
	</tr>
...
<?php else: ?>
<p>Nenhuma alteração de e-mail encontrada. <a href="javascript:history.go(-1)">Voltar</a>.</p>
<?php endif ?>
