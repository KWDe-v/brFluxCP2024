...
<body>
    <div class="container">
        ...
        <br />
<br />
<p class="yellow" style="text-align: center; font-weight: bold">"Seu pagamento está em análise. Assim que seu pagamento for aprovado, você receberá seus Créditos!"<br/> - <?php echo htmlspecialchars($session->loginAthenaGroup->serverName) ?> - </p>
