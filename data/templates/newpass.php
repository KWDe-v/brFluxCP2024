...
$emailTitle = 'Sua Senha foi Redefinida';
$meses = [
    'January' => 'Janeiro',
    'February' => 'Fevereiro',
    'March' => 'Março',
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Aqui estão os detalhes da sua nova senha.</p>
            </td>
          </tr>
          <!-- end copy -->
           <tr>
    <td align="center" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
      <table border="0" cellpadding="0" cellspacing="0" width="100%" >
        ...
        <tr >
          <td align="center" style="border: 1px #000 solid;">Nova Senha:</td>
          <td align="center" style="border: 1px #000 solid;">{NewPassword}</td>
        </tr>
      </table>
    </td>
  </tr>
