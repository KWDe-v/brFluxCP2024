...
<body style="background-color: #e9ecef;">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Você recebeu este e-mail porque ativou alertas por e-mail para novos tickets.</p>
            </td>
          </tr>
          <!-- end copy -->
           <tr>
    <td align="center" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
      <table border="0" cellpadding="0" cellspacing="0" width="100%" >
        <tr>
          <td align="center" style="border: 1px #000 solid;">Categoria:</td>
          <td align="center" style="border: 1px #000 solid;">{Category}</td>
        </tr>
        <tr>
          <td align="center" style="border: 1px #000 solid;">Assunto:</td>
          <td align="center" style="border: 1px #000 solid;">{Subject}</td>
        </tr>
        <tr >
          <td align="center" style="border: 1px #000 solid;">Texto:</td>
          <td align="center" style="border: 1px #000 solid;">{Text}</td>
        </tr>
      </table>
    </td>
  </tr>
                ...
                <tr>
                  <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" >
                          <a href="{ViewTicket}" target="_blank" ><div class="viewticket">Ver Ticket</div></a>
                        </td>
                      </tr>
                    </table>
                  </td>
