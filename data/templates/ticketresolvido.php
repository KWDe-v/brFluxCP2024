        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Você recebeu este e-mail porque o membro da equipe de suporte: <strong>{Staff}</strong> resolveu seu ticket de ID: <strong>{TicketID}</strong>.</p>
            </td>
          </tr>
          <!-- end copy -->
                ...
                <tr>
                  <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" >
                          <a href="{ViewID}" target="_blank" ><div class="viewticket">Ver Resultado</div></a>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              ...
              <p style="margin: 0;"><a href="{ViewID}" target="_blank">{ViewID}</a></p>
            </td>
          </tr>
          <!-- end copy -->
