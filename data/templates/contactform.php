...
$emailTitle = 'Envio de formulário de contato';
$meses = [
    'January' => 'Janeiro',
    'February' => 'Fevereiro',
    'March' => 'Março',
...
<body style="background-color: #e9ecef;">
  ...
  <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    ...
    <p>Envio de formulário de contato.</p>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Um membro do nosso site enviou uma pergunta/consulta.</p>
            </td>
          </tr>
          <!-- end copy -->
           <tr>
    <td align="center" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
      <table border="0" cellpadding="0" cellspacing="0" width="100%" >
        <tr>
          <td align="center" style="border: 1px #000 solid;">AccountID:&nbsp;&nbsp;</td>
          <th align="center" style="border: 1px #000 solid;">{AccountID}</th>
        </tr>
        <tr>
          <td align="center" style="border: 1px #000 solid;">Name:&nbsp;&nbsp;</td>
          <th align="center" style="border: 1px #000 solid;">{Name}</th>
        </tr>
        <tr>
          <td align="center" style="border: 1px #000 solid;">Email:&nbsp;&nbsp;</td>
          <th align="center" style="border: 1px #000 solid;">{Email}</th>
        </tr>
        <tr>
          <td align="center" style="border: 1px #000 solid;">Subject:&nbsp;&nbsp;</td>
          <th align="center" style="border: 1px #000 solid;">{Subject}</th>
        </tr>
        <tr>
          <td align="center" style="border: 1px #000 solid;">Body:&nbsp;&nbsp;</td>
          <th align="center" style="border: 1px #000 solid;">{Body}</th>
        </tr>
        <tr>
          <td align="center" style="border: 1px #000 solid;">IP:&nbsp;&nbsp;</td>
          <th align="center" style="border: 1px #000 solid;">{IP}</th>
        </tr>
        </tr>
      </table>
    </td>
