...
$emailTitle = 'Confirmação de Conta';
$meses = [
    'January' => 'Janeiro',
    'February' => 'Fevereiro',
    'March' => 'Março',
...
<body style="background-color: #e9ecef;">
  ...
  <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    <?php if ($expire=Flux::config('EmailConfirmExpire')): ?>
		<p>Todas as contas não confirmadas serão excluídas do nosso sistema dentro de <?php echo (int)$expire ?> hora(s) após o registro.</p>
		<?php endif ?>
  </div>
  <!-- end preheader -->
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Toque no botão abaixo para confirmar seu endereço de e-mail. Você recebeu este e-mail porque recebemos uma solicitação de criação para sua conta. Se você não criou uma conta em <strong><?php echo htmlspecialchars($siteTitle) ?></strong>, você pode excluir este e-mail com segurança..</p>
            </td>
          </tr>
          <!-- end copy -->
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          <a href="{ConfirmationLink}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Confirmar E-mail</a>
                        </td>
                      </tr>
                    </table>
                  </td>
